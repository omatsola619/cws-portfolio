                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Creative Winds Solutions, Empowering Businesses with Smart Innovation
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">We deliver exceptional software solutions designed to meet your business needs, driving growth and success.</div>
